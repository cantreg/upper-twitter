...
function WheelPick(containerSelector = window,
                   rotatorSelector = '.rotator',
                   resultSelector = '#result',
                   niche = [0,0,5],
                   onChangeCallback) {

    var gate = $(containerSelector),
        cog = $(rotatorSelector),
        ...
        base = 1.5*slot,
        list = [],
        term = 250, // duration of full animation cycle will be discounted with dragging distance
        up = true,
    ...
    function tallyCells() {
        ...
        cog.each(function() {
            ...
            for (var i = 0; i < 10; i++) {
                ...
                if (i == 9) $(this).children().wrapAll('<div></div>');
            }
        });
    }
